...
The authoritative schema lives in supabase/schema.sql. The products table uses JSONB blobs for agent outputs, NOT broken-out columns.
...
- image_urls text[]
- voice_transcript text (English, post-Whisper)
- language_detected text
- listing_json jsonb (full Listing Agent output)
- pricing_json jsonb (full Pricing Agent output)
...
RLS: public select + anon insert on both tables.
